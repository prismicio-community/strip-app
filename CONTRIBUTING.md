...
# Clone your fork
git clone git@github.com:<your-username>/strip-app.git
...
## `strip-app` in Prismic's Open-Source Ecosystem
...
[repo-issue]: https://github.com/prismicio-community/strip-app/issues/new/choose
